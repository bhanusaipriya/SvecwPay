...
public class AllPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Payment Types");
                ...
                users1.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(user_id.equals("workshop")){
                            Intent intent = new Intent(getApplicationContext(),Workshoplist.class);
                            startActivity(intent);
                        }
                        else if(user_id.equals("program")){
                            Intent intent = new Intent(getApplicationContext(),Programlist.class);
                            startActivity(intent);
                        }
