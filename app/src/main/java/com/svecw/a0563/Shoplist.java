...
public class Shoplist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("shop");
        muserslist = (RecyclerView) findViewById(R.id.shoplist);
            ...
            protected void populateViewHolder(usersviewHolder users1, Users users,final int position) {
                ...
                users1.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view){
                        Intent pIntent = new Intent( Shoplist.this,Amount.class);
                        pIntent.putExtra("usercategory","shop");
