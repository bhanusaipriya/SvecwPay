                ...
                users1.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(user_id.equals("workshop")){
                            Intent intent = new Intent(getApplicationContext(),workshophistory.class);
                            startActivity(intent);
                        }
                        else if(user_id.equals("program")){
                            Intent intent = new Intent(getApplicationContext(),programhistory.class);
                            startActivity(intent);
                        }
                        else if(user_id.equals("student")){
                            Intent intent = new Intent(getApplicationContext(),studenthistory.class);
                            startActivity(intent);
                        }
                        else if(user_id.equals("shop")){
                            Intent intent = new Intent(getApplicationContext(),shophistory.class);
                            startActivity(intent);
                        }
                    }
                });
