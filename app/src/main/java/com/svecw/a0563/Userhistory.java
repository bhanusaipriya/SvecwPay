...
public class Userhistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getIntent().getStringExtra("category")+"history");
        getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        objlist = new ArrayList<>();
        mcurrentuser = FirebaseAuth.getInstance().getCurrentUser();
        mprogram = FirebaseDatabase.getInstance().getReference().child("Users").child("student");
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Transactions").child(getIntent().getStringExtra("category")).child(mcurrentuser.getUid()).child("student");
