...
public class shophistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Shop history");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        objlist = new ArrayList<>();
        mcurrentuser = FirebaseAuth.getInstance().getCurrentUser();
        mprogram = FirebaseDatabase.getInstance().getReference().child("Users").child("shop");
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Transactions").child("student").child(mcurrentuser.getUid()).child("shop");
    ...
    protected  void onStart() {
        super.onStart();
        final DatabaseReference program = FirebaseDatabase.getInstance().getReference().child("Users").child("shop");
