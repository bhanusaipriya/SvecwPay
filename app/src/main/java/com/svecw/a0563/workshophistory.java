...
public class workshophistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workshophistory);
        mToolbar = (Toolbar) findViewById(R.id.pay_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("WorkShop history");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        objlist = new ArrayList<>();
        mcurrentuser = FirebaseAuth.getInstance().getCurrentUser();
        mprogram = FirebaseDatabase.getInstance().getReference().child("Users").child("workshop");
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Transactions").child("student").child(mcurrentuser.getUid()).child("workshop");
    ...
    protected  void onStart() {
        super.onStart();
        final DatabaseReference program = FirebaseDatabase.getInstance().getReference().child("Users").child("workshop");
